...
const STR = {
  ...
  pixValor:    { pt: '{brl} · equivale a {eur} na cotação de hoje',
                 en: '{brl} · equals {eur} at today\'s rate' },
  ...
  admFx:      { pt: 'Mostrar o preço em reais para clientes brasileiros', en: 'Show prices in Brazilian reais' },
  ...
  admFxHelp:  { pt: 'A cotação vem do Banco Central Europeu e atualiza sozinha. A margem cobre o spread da conversão e a taxa de quem processa — sem ela, chega menos euro do que o preço pedido.',
                en: 'The rate comes from the European Central Bank and updates on its own. The margin covers the conversion spread and the processing fee — without it you receive less than the listed price.' },
  admFxMargem:{ pt: 'Margem sobre a cotação (%)', en: 'Margin over the rate (%)' },
  aproxBrl:   { pt: '≈ {v} na cotação de hoje', en: '≈ {v} at today\'s rate' },
  fxResumo:   { pt: 'Hoje 1 € = R$ {taxa}. Com esta margem, {eur} sai a {brl}.',
                en: 'Today 1 € = R$ {taxa}. With this margin, {eur} comes to {brl}.' },
  fxSemCotacao:{ pt: 'Sem cotação no momento — o preço em real não aparece para o cliente.',
                 en: 'No rate available — the price in reais is not shown to clients.' },
  ...
  admAvisoHelp: { pt: 'Quando alguém reservar pelo site, chega um e-mail aqui com o passeio, a data, quantas pessoas e o contato. É só responder o e-mail que a resposta vai direto para o cliente.',
                  en: 'When someone books on the site, an email lands here with the tour, date, number of people and their contact. Just hit reply and it goes straight to the client.' },
  ...
  admCli:     { pt: 'Mandar e-mail para o cliente também',
                en: 'Email the client as well' },
  admCliHelp: { pt: 'Assim que alguém reserva, ele recebe um recibo com os dados e o Pix para pagar. Depois, quando o dinheiro cair, você aperta "Avisar cliente" na reserva e ele recebe a confirmação.',
                en: 'As soon as someone books, they get a receipt with the details and the Pix code to pay. Later, once the money arrives, you press "Notify client" on the booking and they get the confirmation.' },
  admCliNota: { pt: 'O recibo sai sozinho. A confirmação nunca sai sozinha — só quando você apertar, porque só você sabe se o dinheiro entrou.',
                en: 'The receipt goes out on its own. The confirmation never does — only when you press it, because only you know whether the money arrived.' },
  confCliente:      { pt: 'Avisar cliente', en: 'Notify client' },
  confClienteFeito: { pt: 'cliente avisado', en: 'client notified' },
  confClienteAsk:   { pt: 'Mandar a confirmação de pagamento para {email}?\n\nO e-mail sai em até 30 minutos e não tem como voltar atrás.',
                      en: 'Send the payment confirmation to {email}?\n\nThe email goes out within 30 minutes and cannot be undone.' },
  confClienteOk:    { pt: 'Pronto — {name} vai receber a confirmação', en: 'Done — {name} will get the confirmation' },
  /* ---- o que o cliente recebe, editavel por ela ---- */
  emRecTit:    { pt: '1. Recibo — o que ele recebe ao reservar', en: '1. Receipt — what they get when booking' },
  emRecQuando: { pt: 'Sai sozinho, logo depois da reserva. Nunca diz que está pago.',
                 en: 'Goes out on its own, right after booking. Never says it is paid.' },
  emConfTit:    { pt: '2. Confirmação — quando você aperta "Avisar cliente"', en: '2. Confirmation — when you press "Notify client"' },
  emConfQuando: { pt: 'Só sai no seu clique, porque só você sabe se o dinheiro caiu.',
                  en: 'Only on your click, because only you know whether the money arrived.' },
  ...
  emPix:    { pt: '— quanto pagar agora e o código Pix, com o valor já dentro —',
              en: '— how much to pay now and the Pix code, amount included —' },
  emAviso:  { pt: '🔒 “Este e-mail é o comprovante da sua reserva, não do pagamento.” — esta frase não sai. Sem ela, quem não pagou acha que está tudo certo.',
              en: '🔒 “This email confirms your booking, not your payment.” — this line stays. Without it, someone who has not paid thinks they are all set.' },
  ...
  emRecIntroPad:   { pt: 'Recebemos sua reserva. Abaixo está tudo o que você reservou e como pagar.',
                     en: 'Recebemos sua reserva. Abaixo está tudo o que você reservou e como pagar.' },
  emRecIntroPadEn: { pt: 'We have received your booking. Below is everything you booked and how to pay.',
                     en: 'We have received your booking. Below is everything you booked and how to pay.' },
